...
//-------------------------------------------------------------
typedef bool (rpl_completion_fun_t)( rpl_env_t* env, void* funenv, const char* replacement, const char* display, const char* help, long delete_before, long delete_after );
