...
rpl_private void
editstate_init(editstate_t ** es)
{
	*es = NULL;
}

rpl_private void
editstate_done(alloc_t * mem, editstate_t ** es)
{
	while (*es != NULL) {
...
rpl_private void
editstate_capture(alloc_t * mem, editstate_t ** es, const char *input,
                  ssize_t pos)
{
	if (input == NULL)
		input = "";
...
rpl_private bool
editstate_restore(alloc_t * mem, editstate_t ** es, const char **input,
                  ssize_t * pos)
{
	if (*es == NULL)
		return false;
