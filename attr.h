...
rpl_private ssize_t attrbuf_append_n(stringbuf_t * sb, attrbuf_t * ab,
                                     const char *s, ssize_t len, attr_t attr);

rpl_private void attrbuf_set_at(attrbuf_t * ab, ssize_t pos, ssize_t count,
                                attr_t attr);
rpl_private void attrbuf_update_at(attrbuf_t * ab, ssize_t pos, ssize_t count,
                                   attr_t attr);
rpl_private void attrbuf_insert_at(attrbuf_t * ab, ssize_t pos, ssize_t count,
                                   attr_t attr);
